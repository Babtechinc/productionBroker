"""
Django settings for productionBroker project.
...
SECRET_KEY = 'django-insecure-hi#zb%9r$1v&in5+z=y6hp94&0)quus$u3mwl-3r=&p(#t)1o0'
...
ROOT_URLCONF = 'productionBroker.urls'
...
ASGI_APPLICATION = "productionBroker.asgi.application"
WSGI_APPLICATION = 'productionBroker.wsgi.application'

# MQTT Broker Configurations

MQTT_BROKER_HOST = env('MQTT_BROKER_HOST',default='mqtt')
MQTT_BROKER_PORT = env('MQTT_BROKER_PORT',default=1883)
MQTT_CENTRAL_TOPIC = env('MQTT_CENTRAL_TOPIC',default='vandalrobot')
