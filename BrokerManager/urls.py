...
urlpatterns = [
    ...
    path('report/full/Fault', views.fullreport_production_Fault, name='fullreport_production_Fault'),
    path('all/report/full/Fault', views.fullreport_Fault, name='fullreport_Fault'),
    path('single-report/<str:node>', views.singlereport_production_node, name='singlereport_production_node'),
    path('single-report/fault/<str:nodeid>', views.singlereport_production_Fault, name='singlereport_production_Fault'),
